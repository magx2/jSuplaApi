...
public class Channel {
  ...
  **/
    @Schema(description = "Channel ordinal number in its IO Device")
  ...
  public Channel caption(String caption) {
     ...
     * @return caption
  **/
    @Schema(description = "Channel caption")
  ...
  **/
  ...
  public Channel altIcon(Integer altIcon) {
     ...
     * @return altIcon
     **/
    @Schema(description = "Chosen alternative icon idenifier. Should not be greater than `funciton.maxAlternativeIconIndex`")
  ...
  public Channel hidden(Boolean hidden) {
     ...
     * @return hidden
     **/
    @Schema(description = "Whether this channel is shown on client apps or not")
  ...
  public Channel inheritedLocation(Boolean inheritedLocation) {
     ...
     **/
    @Schema(description = "Whether this channel inherits its IO Device's location (`true`) or not (`false`)")
  ...
  **/
  ...
  public boolean equals(java.lang.Object o) {
    ...
    @Override
    public int hashCode() {
        return java.util.Objects.hash(id, channelNumber, caption, type, function, param1, param2, param3, textParam1, textParam2, textParam3, altIcon, hidden, inheritedLocation, iodeviceId, locationId, functionId, typeId, userIconId, iodevice, location, connected, state, supportedFunctions);
  }
