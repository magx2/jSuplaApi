 ...
 */
@Schema(description = "Multipart request with files to save as a new icon. The number of images required to be sent with the request is determined by the chosen function identifier (it must match the `function.possibleVisualStates` count). Each image represents the respective visual state from `function.possibleVisualStates` array.")
...
public class Body {
     ...
     * @return sourceIcon
     **/
    @Schema(description = "ID of an existing user icon to replace with these new files. Optional.")
    ...
    @Override
    public int hashCode() {
        return java.util.Objects.hash(function, sourceIcon, image1, image2, image3, image4);
    }
