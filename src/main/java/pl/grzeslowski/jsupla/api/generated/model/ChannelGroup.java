...
public class ChannelGroup {
  ...
  public ChannelGroup id(Integer id) {
     ...
     * @return id
  **/
    @Schema(example = "1", description = "Channel group identifier")
  ...
  public ChannelGroup hidden(Boolean hidden) {
     ...
     * @return hidden
  **/
    @Schema(description = "Whether this channel group is shown on client apps or not")
  ...
  **/
  ...
  @Override
  public int hashCode() {
      return java.util.Objects.hash(id, hidden, caption, function, functionId, userIconId, locationId, location, channelIds, channels, altIcon);
  }
