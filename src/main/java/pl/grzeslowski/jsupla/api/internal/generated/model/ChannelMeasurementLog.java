...
public class ChannelMeasurementLog {
  ...
  **/
  ...
  public ChannelMeasurementLog temperature(Float temperature) {
     ...
     * @return temperature
  **/
    @Schema(example = "21.56", description = "Temperature in Celsius")
  ...
  public ChannelMeasurementLog humidity(Float humidity) {
     ...
     * @return humidity
  **/
    @Schema(example = "48.8", description = "Humidity percent. Available only if channel function is `HUMIDITYANDTEMPERATURE`.")
  ...
  @Override
  public int hashCode() {
      return java.util.Objects.hash(dateTimestamp, temperature, humidity);
  }
