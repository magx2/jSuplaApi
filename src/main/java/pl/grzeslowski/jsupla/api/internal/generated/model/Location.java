...
public class Location {
  ...
  **/
  ...
  public Location addIodevicesIdsItem(Integer iodevicesIdsItem) {
     ...
     * @return iodevicesIds
  **/
    @Schema(description = "array containing the IO Devices identifiers assigned to this location")
  ...
  **/
    @Schema(description = "array containing the Channel groups identifiers assigned to this location")
  ...
  public Location addChannelsIdsItem(Integer channelsIdsItem) {
     ...
     * @return channelsIds
  **/
    @Schema(description = "array containing the Channels identifiers expicitely assigned to this location")
  ...
  public Location addAccessIdsIdsItem(Integer accessIdsIdsItem) {
     ...
     * @return accessIdsIds
  **/
    @Schema(description = "array containing the Access Identifiers identifiers assigned to this location")
  ...
  public Location password(String password) {
     ...
     * @return password
  **/
    @Schema(description = "Location password (plain text). Returned only if requested by the `include` parameter.")
  ...
  **/
    @Schema(example = "[]", description = "Returned only if requested by the `include` parameter.")
  ...
  **/
  ...
  @Override
  public int hashCode() {
      return java.util.Objects.hash(id, caption, enabled, iodevicesIds, channelGroupsIds, channelsIds, accessIdsIds, password, iodevices, channelGroups, accessIds, channels);
  }
