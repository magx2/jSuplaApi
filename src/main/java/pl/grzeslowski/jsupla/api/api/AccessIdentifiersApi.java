...
public class AccessIdentifiersApi {
     ...
     * @throws ApiException If fail to serialize the request body object
     */
    public com.squareup.okhttp.Call updateAccessIdentifierCall(Integer id, AccessIdentifierUpdateRequest body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
    ...
    @SuppressWarnings("rawtypes")
    private com.squareup.okhttp.Call updateAccessIdentifierValidateBeforeCall(Integer id, AccessIdentifierUpdateRequest body, final ProgressResponseBody.ProgressListener progressListener, final ProgressRequestBody.ProgressRequestListener progressRequestListener) throws ApiException {
        ...
        com.squareup.okhttp.Call call = updateAccessIdentifierCall(id, body, progressListener, progressRequestListener);
        return call;
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public AccessIdentifier updateAccessIdentifier(Integer id, AccessIdentifierUpdateRequest body) throws ApiException {
        ApiResponse<AccessIdentifier> resp = updateAccessIdentifierWithHttpInfo(id, body);
        return resp.getData();
    }
     ...
     * @throws ApiException If fail to call the API, e.g. server error or cannot deserialize the response body
     */
    public ApiResponse<AccessIdentifier> updateAccessIdentifierWithHttpInfo(Integer id, AccessIdentifierUpdateRequest body) throws ApiException {
        com.squareup.okhttp.Call call = updateAccessIdentifierValidateBeforeCall(id, body, null, null);
        Type localVarReturnType = new TypeToken<AccessIdentifier>(){}.getType();
        return apiClient.execute(call, localVarReturnType);
    }
     ...
     * @throws ApiException If fail to process the API call, e.g. serializing the request body object
     */
    public com.squareup.okhttp.Call updateAccessIdentifierAsync(Integer id, AccessIdentifierUpdateRequest body, final ApiCallback<AccessIdentifier> callback) throws ApiException {
        ...
        com.squareup.okhttp.Call call = updateAccessIdentifierValidateBeforeCall(id, body, progressListener, progressRequestListener);
        Type localVarReturnType = new TypeToken<AccessIdentifier>(){}.getType();
        apiClient.executeAsync(call, localVarReturnType, callback);
        return call;
    }
